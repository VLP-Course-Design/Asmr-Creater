...
- scene_type 按 contracts/scene_type_vocabulary.json(音频层 v1.0,424 值)取值,scene_group 查表生成,none/other_* 兜底(v6 起,2.3 对齐版);suggested_entities 只输出 contracts/anchor_dictionary.json 的 87 个锚点 id。
